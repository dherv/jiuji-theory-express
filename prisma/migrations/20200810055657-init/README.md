# Migration `20200810055657-init`

This migration has been generated by dherv at 8/10/2020, 2:56:57 PM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
ALTER TABLE `jiuji-theory`.`Submission` DROP COLUMN `default`;
```
