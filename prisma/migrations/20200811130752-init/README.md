# Migration `20200811130752-init`

This migration has been generated at 8/11/2020, 1:07:52 PM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
ALTER TABLE `jiuji-theory`.`Video` ADD COLUMN `youtubeId` varchar(191) NOT NULL ;
```
